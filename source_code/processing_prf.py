...
if __name__ == "__main__":
    ...
    out_folder = '/mnt/bigtex/Users/ejg2736/for_amy/PRF/atl08_30m'
    ...
    out_folder = '/mnt/bigtex/Users/ejg2736/for_amy/PRF/truth_30m'
    ...
    out_folder = '/mnt/bigtex/Users/ejg2736/for_amy/PRF/atl08_30m_pc'
    out_name = atl03.atlFileName + '_' + gt + '_' + str(res) + '_pc.mat'
    out_file = os.path.join(out_folder, out_name)
    
    atl03.df['classification'] = measpc
    atl08_bin = rebin_atl08(atl03, atl08, gt, res, res_field)
    dictionary = atl08_bin.to_dict('list')
    sio.savemat(out_file,dictionary)
    # Do Binner
