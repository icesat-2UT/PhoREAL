...
if __name__ == "__main__":
    ...
    # User options
    trimInfo = 'manual,time,5,6'   # OPTIONS: ('none', 'auto', or 'manual')
    ...
    useMeasSigConf = False             # Use measured signal confidence (or use ground truth)
                                       # Meas Classes (0 = Unclass, 1 = Ground, 2 = Low Veg, 3 = High Veg)
    filterData = 2               # Signal Confidence (0, 1, 2, 3, 4) or Texpert Truth Classes (0 = Unclass, 2 = Ground, 4 = Veg, 6 = Building)
